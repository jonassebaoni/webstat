...
const {PieChart, Pie, Tooltip, Label, Legend, ResponsiveContainer, Sector, Cell, LabelList} = Recharts;
    ...
    render() {
        ...
        return (
            <ResponsiveContainer aspect={16.0/9.0}>
                <PieChart>
                    <Pie data={this.props.ticketsFiltered}
                         nameKey="_id"
                         dataKey="sum"
                         fill="#82ca9d"
                         labelLine={false}
                        ...
                        {
                            this.props.ticketsFiltered.map((entry, index) => <Cell fill={COLORS[index % COLORS.length]}/>)
                        }
